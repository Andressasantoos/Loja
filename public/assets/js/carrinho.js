       ...
       $('.btn-del-item').on('click', function () {
        ...
        $.ajax({
          ...
          if (response.erro === 0) {
              ...
              alert('Não foi possivel excluir o produto. Contate o suporte');
          }
          ...
          if(produto_quantidade == "" || produto_quantidade < 1){
            ...
            $.ajax({
              ...
              if (response.erro === 0) {
                  ...
                  //$('#preco_atualiza').load(' #preco_atualiza > *');
      ...
      $('.btn-limpa-carrinho').on('click', function () {
        ...
        $.ajax({
          ...
          if (response.erro === 0) {
            ...
            $('#mensagem').html('<div class="alert alert-success alert-dismissible fade show mt-2" role="alert"> Houve um erro contate o suporte <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">&times;</span></button> </div>');
