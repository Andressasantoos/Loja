...
class Master extends CI_Controller{
    ...
    public function core($categoria_pai_id = NULL){
        ...
        if(!$categoria_pai_id){
            ...
            $this->form_validation->set_rules('categoria_pai_nome', 'Nome da Categoria', 'trim|required|min_length[3]|max_length[40]|callback_valida_nome_categoria');
    ...
    //valida a categoria em cadastro e editar cadastro
