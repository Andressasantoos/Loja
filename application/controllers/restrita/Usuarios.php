 ...
 class Usuarios extends CI_Controller{
     ...
     public function valida_email($email){
        ...
        if(!$usuario_id) {
             ...
             //Cadastrando
            $query = $this->core_model->getVerificarEmail($email);
            ...
            //Editando
            $query = $this->core_model->getVerificarEmailUsuario($usuario_id,$email);
      ...
      public function valida_usuario($username){
        ...
        if(!$usuario_id) {
             ...
             //Cadastrando
            $query = $this->core_model->getVerificarUsuario($username);
            ...
            //Editando
            $query = $this->core_model->getVerificarUser($usuario_id,$username);
