          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="folder-minus"></i><span>Categorias</span></a>
            ...
            <li class="dropdown  <?php echo $this->router->fetch_class() == 'produtos' && $this->router->fetch_method() == 'index' ? 'active' : ''; ?>">
              <a href="<?php echo base_url('restrita/produtos') ?>" class="nav-link"><i data-feather="package"></i><span>Produtos</span></a>
            </li>  
