                ...
                <div class="card">
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" name="marca_nome" placeholder="Nome da Marca" value="<?php echo (isset($marca) ? $marca->marca_nome : set_value('marca_nome') ) ?>">                                                     
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <?php if(isset($marca)): ?>  
                        <div class="form-group col-md-4">
                            <label for="inputEmail4">Metalink da Marca</label>
                            <input type="text" class="form-control border-0" name="marca_meta_link" placeholder="Metalink da Marca" value="<?php echo $marca->marca_meta_link; ?>" readonly="">                                                     
                          </div>
                     <?php endif; ?>
                      </div>
