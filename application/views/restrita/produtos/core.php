              ...
              <div class="col-12">
                <div class="card">
                 ...
                 <?php if(isset($produto)): ?>
                  ...
                  <div class="form-row">
                     <div class="col-md-12">
                         <label for="inputEmail4">Metalink do Produto</label>
                         <p class="text-info"><i data-feather="link-2"></i>&nbsp;&nbsp;<?php echo $produto->produto_meta_link ?></p>
                    </div>
                  </div>
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-2">
                        <label for="inputEmail4">Código do Produto</label>
                        <input type="text" class="form-control border-0" name="produto_codigo" placeholder="Código do Produto" value="<?php echo (isset($produto) ? $produto->produto_codigo : $codigo_gerado ) ?>" readonly="">                                                     
                        <?php echo form_error('produto_codigo', '<div class="text-danger">', '</div>'); ?>
                      </div>

                      <div class="form-group col-md-5">
                        <label for="inputEmail4">Nome do Produto</label>
                        <input type="text" class="form-control" name="produto_nome" placeholder="Nome do Produto" value="<?php echo (isset($produto) ? $produto->produto_nome : set_value('produto_nome') ) ?>">                                                     
                ...
                <div class="form-row">     
                    ...
                    <div class="form-group col-md-2">
                        <label for="inputEmail4">Preço do Produto</label>
                        <input type="text" class="form-control money2" name="produto_valor" placeholder="Preço do Produto" value="<?php echo (isset($produto) ? $produto->produto_valor : set_value('produto_valor') ) ?>">                                                     
                        <?php echo form_error('produto_valor', '<div class="text-danger">', '</div>'); ?>
                      </div>

                      <div class="form-group col-md-2">
                        <label for="inputEmail4">Peso do Produto</label>
                        <input type="number" class="form-control" name="produto_peso" placeholder="Peso do Produto" value="<?php echo (isset($produto) ? $produto->produto_peso : set_value('produto_peso') ) ?>">                                                     
                        <?php echo form_error('produto_peso', '<div class="text-danger">', '</div>'); ?>
                      </div>

                      <div class="form-group col-md-2">
                        <label for="inputEmail4">Altura do Produto</label>
                        <input type="number" class="form-control" name="produto_altura" placeholder="Altura do Produto" value="<?php echo (isset($produto) ? $produto->produto_altura : set_value('produto_altura') ) ?>">                                                     
                        <?php echo form_error('produto_altura', '<div class="text-danger">', '</div>'); ?>
                      </div>

                      <div class="form-group col-md-2">
                        <label for="inputEmail4">Largura do Produto</label>
                        <input type="number" class="form-control" name="produto_largura" placeholder="Largura do Produto" value="<?php echo (isset($produto) ? $produto->produto_largura : set_value('produto_largura') ) ?>">                                                     
                        <?php echo form_error('produto_largura', '<div class="text-danger">', '</div>'); ?>
                      </div>

                      <div class="form-group col-md-2">
                        <label for="inputEmail4">Comprimento do Produto</label>
                        <input type="number" class="form-control" name="produto_comprimento" placeholder="Comprimento do Produto" value="<?php echo (isset($produto) ? $produto->produto_comprimento : set_value('produto_comprimento') ) ?>">                                                     
                ...
                <div class="form-row">   
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <input type="number" class="form-control" name="produto_quantidade_estoque" placeholder="Quantidade em Estoque" value="<?php echo (isset($produto) ? $produto->produto_quantidade_estoque : set_value('produto_quantidade_estoque') ) ?>">                                                     
                  ...
                  <div class="form-row"> 
                     ...
                     <div class="form-group col-md-8">
                        ...
                        <textarea class="form-control" name="produto_descricao" rows="5" style="min-height:100px"><?php echo (isset($produto) ? $produto->produto_descricao : set_value('produto_descricao') ) ?></textarea>
                  ...
                  <div class="form-row"> 
                     ...
                     <div class="form-group col-md-8">
                        <label for="inputEmail4">Imagens do Produto</label>
                        <div id="fileuploader">
